...
export PREPROC_WORKERS="${PREPROC_WORKERS:-32}"
...
export TRAIN_FP16="${TRAIN_FP16:-False}"
export TRAIN_TF32="${TRAIN_TF32:-True}"
export TRAIN_USE_FLASH_ATTN="${TRAIN_USE_FLASH_ATTN:-False}"
export TRAIN_PER_DEVICE_BATCH_SIZE="${TRAIN_PER_DEVICE_BATCH_SIZE:-1}"
export TRAIN_GRADIENT_ACCUMULATION_STEPS="${TRAIN_GRADIENT_ACCUMULATION_STEPS:-16}"
